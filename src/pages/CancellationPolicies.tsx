  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="container max-w-4xl mx-auto py-8 px-4">
        ...
        <h1 className="text-4xl font-bold mb-8">Políticas de Cancelación</h1>
        
        <ScrollArea className="h-[calc(100vh-200px)] pr-4">
          <div className="space-y-6">
            <section>
              <h2 className="text-2xl font-semibold mb-4">1. Proceso de Cancelación</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4">2. Plazos de Cancelación</h2>
              <p className="text-muted-foreground leading-relaxed">
