      ...
      <div className="container max-w-4xl mx-auto py-8 px-4">
        ...
        <ScrollArea className="h-[calc(100vh-200px)] pr-4">
          <div className="space-y-6">
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-white">1. Uso Aceptable</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-white">2. Contenido del Usuario</h2>
              <p className="text-gray-300 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-white">3. Seguridad</h2>
              <p className="text-gray-300 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-white">4. Monitoreo y Cumplimiento</h2>
              <p className="text-gray-300 leading-relaxed">
